...
class MutualAction extends Action
{
    ...
    public function shield()
    {
        ...
        if (isset($_GET['list'])) {
            ...
            $userLogin = $UserLogin->find($shieldUid);
            if (empty($userLogin)) {
    ...
    public function rc()
    {
        ...
        if ($_COOKIE['userRealConnectTimes'] > 6) {
    ...
    public function find()
    {
        ...
        if (preg_match("/recordcontent/iUs", $_SERVER["REQUEST_URI"])) {
            ...
            if (!empty($recordcontent) && is_int($p)) {
                ...
                ->field("i_record_say.uid,i_record_say.sid,i_record_say.say_type,i_record_say.content,i_record_say.time,i_user_login.nickname,i_user_login.icon_url,i_school_info.id,i_school_info.school,i_school_info.domain,i_school_info.domain_main")
