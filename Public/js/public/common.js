    		...
    		$.ajax({
        		...
        		success:function(msg){
                	if (!msg.status) {
    					...
    					+ "       <p class='user_info_top_div_quan_p black_l'>圈的:<span class='fb f14'>"+msg.data.follow+"</span> 圈子:<span class='fb f14'>"+msg.data.fans+"</span> "+userconstellation+"<span class='sex"+msg.data.sex+"'></span> "+relationhtml+" <a href='/talk/to"+msg.data.uid+"' class='btn_quaned'>悄悄话</a></p>"
    					+ "		</div>"
