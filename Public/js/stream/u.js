$().ready(function(){
    ...
    $('.stream_u_img_more_p').hover(function(){
    	$('.stream_u_img_more_btn_more').addClass('stream_u_img_more_btn_more_focus');
    }, function(){
        $('.stream_u_img_more_btn_more').removeClass('stream_u_img_more_btn_more_focus');
    });
});
function showtime(){
	today = new Date(); 
