    ...
    $('.s_li_p_content_image img').live('click', function(){
    	...
    	if (totalImageNums > 1) {
	    	...
	    	if (enlargeSwitch != 'on') {
		    	...
		    	var $imageobjectpart = $(this).parent().html('<p class="f12 s_li_p_content_image_title" style="min-height:120px;"><a href="'+imageurllarge+'" target="_blank"><span class="icon_plus"></span>查看原图</a> <a class="s_li_p_content_image_title_up"><span class="icon_up"></span>收起</a></p><img class="enlargeimg" src="'+baseUrl+'Public/image/common/ajax_wait_login.gif" enlargeswitch="on" title="点击缩小" />');
