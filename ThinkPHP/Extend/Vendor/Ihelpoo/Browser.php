<?php
	...
	class Browser {
		...
		const BROWSER_UNKNOWN = '其他浏览器';
		const VERSION_UNKNOWN = '未知版本';

		const BROWSER_OPERA = 'Opera';                            // http://www.opera.com/
		const BROWSER_OPERA_MINI = 'Opera Mini';                  // http://www.opera.com/mini/
		const BROWSER_WEBTV = 'WebTV';                            // http://www.webtv.net/pc/
		const BROWSER_IE = 'IE';                   // Internet Explorer http://www.microsoft.com/ie/
		const BROWSER_POCKET_IE = 'Pocket IE';     // Pocket Internet Explorer http://en.wikipedia.org/wiki/Internet_Explorer_Mobile
